            ...
            <Sequence>
                ...
                <Creator>
                    <DescriptionofCreator>
                        ...
                        <ParallelNameofCreator>
                            <xsl:value-of
                                    select="MetaData.Sequence.Creator.DescriptionofCreator.ParallelNameofCreator"/>
                        </ParallelNameofCreator>
                        <Role>
                ...
                <Contributor>
                    <DescriptionofContributor>
                        <NameofContributor>
                            <xsl:value-of
                                    select="MetaData.Sequence.Contributor.DescriptionofContributor.NameofContributor"/>
                        </NameofContributor>
                        <ParallelNameofContributor>
                            <xsl:value-of
                                    select="MetaData.Sequence.Contributor.DescriptionofContributor.ParallelNameofContributor"/>
                        </ParallelNameofContributor>
                        <Role>
                        ...
                        <OtherInformation>
                            <xsl:value-of
                                    select="MetaData.Sequence.Contributor.DescriptionofContributor.OtherInformation"/>
                        </OtherInformation>
                    </DescriptionofContributor>
                </Contributor>
                <Copyright>
                    <DescriptionofAuthorizedUse>
                        <TimesofAuthorizedUsage>
                            <xsl:value-of
                                    select="MetaData.Sequence.Copyright.DescriptionofAuthorizedUse.TimesofAuthorizedUsage"/>
                        </TimesofAuthorizedUsage>
                    </DescriptionofAuthorizedUse>
                </Copyright>
                <Language>
